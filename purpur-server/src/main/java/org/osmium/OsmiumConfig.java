...
public class OsmiumConfig {
    ...
    public static boolean chunkHidingDisableInSpawnDim = true;
    ...
    private static void chunkHiding() {
        ...
        chunkHidingDisableInSpawnDim = getBoolean("chunk-hiding.disable-in-spawn-dimension", true);
    }
    ...
    private static void raytraceHiding() {
        ...
        raytraceDebug = getBoolean("raytrace-hiding.debug", false);
    }
    ...
    private static void chatTags() {
        chatTagsEnabled = getBoolean("chat-tags.enabled", true);
    }
    ...
    private static void entityOcclusion() {
        ...
        entityOcclusionDebug = getBoolean("entity-occlusion.debug", false);
        entityOcclusionBeMaxDistance = getInt("entity-occlusion.block-entity-max-distance", 128);
    }
    ...
    public static boolean raytraceDebug = false;
    ...
    // Chat tags
    public static boolean chatTagsEnabled = true;
    ...
    public static boolean entityOcclusionDebug = false;
    public static int entityOcclusionBeMaxDistance = 128;
    ...
    private static void reorderYamlFile(File file) {
        try {
            ...
            String[] order = {
                ...
                "chat-tags", "rtp", "tpa", "homes", "team", "scoreboard", "recipes",
